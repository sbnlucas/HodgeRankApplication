...
if step == 8:
    ...
    with st.expander("⚙️ Customize plot", expanded=False):
        ...
        if "type_plotw" not in st.session_state:
            st.session_state["type_plotr"] = "kamada"
            st.session_state["type_plotw"] = "kamada"
...
if step == 11:
    ...
    This project demonstrates the decomposition of edge flows into **gradient**, **curl**, and **harmonic** components,
    with applications in ranking systems and beyond.
    """)

    st.markdown("### Citation and Credits")

    st.write("If you use this app in your research or academic work, please cite it as follows:")

    bibtex_entry = r"""
    @software{hodge_rank_app,
    author       = {Your Name and Collaborators},
    title        = {Hodge Decomposition Ranking App},
    year         = {2025},
    publisher    = {Streamlit Community Cloud},
    url          = {https://streamlit.io/cloud},
    note         = {A Streamlit application for decomposing edge flows into gradient, curl, and harmonic components.}
    }
    """

    st.code(bibtex_entry, language="bibtex")

    st.info("This project is open-source and available for community use on [Streamlit Community Cloud](https://streamlit.io/cloud).")
